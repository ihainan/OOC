<?php    
    ...
    if(array_key_exists("用户id", $_POST)
        ...
        if(array_key_exists("recent_operations", $_COOKIE)){
            ...
            $emptyArray = array(time() => "添加了学院管理人员用户 ".$_POST["用户id"]);
            setcookie("recent_operations", 
        ...
        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xs-offset-0 col-sm-offset-0   toppad" >
          ...
          <div class="panel panel-info">
            <div class="panel-heading">
              <h3 class="panel-title">添加学院管理人员角色</h3>
            </div>
                ...
                <form action="#" method="post" id = "form-id">
                    <table class="table table-user-information">
                        <tbody>
                          ...
                          <tr>
                            <td>用户名：</td>
                            <td><input type="text" value="manager" name="用户id" /></td>
                          </tr>
                          <tr>
                            <td>密码：</td>
                          ...
                          <tr>
                            <td>真实姓名：</td>
                            <td><input type="text" value="隔壁老王" name = "姓名"/></td>
                          </tr>
                          <tr>
                            <td>Email: </td>
                            <td><input type="text" value="manager@bit.edu.cn" name = "Email"/></td>
                          </tr>
                          <tr>
                            <td>电话：</td>
